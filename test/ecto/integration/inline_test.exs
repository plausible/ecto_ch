  ...
  describe "inline and exec" do
    ...
    test "with large integers" do
      ...
      assert one(
               ...
               "SELECT -170141183460469231731687303715884105728 = -170141183460469231731687303715884105728::Int128 FROM system.one AS f0"
      ...
      assert one(
               ...
               "SELECT 170141183460469231731687303715884105727 = 170141183460469231731687303715884105727::Int128 FROM system.one AS f0"
      ...
      assert one(
               ...
               "SELECT -57896044618658097711785492504343953926634992332820282019728792003956564819968 = -57896044618658097711785492504343953926634992332820282019728792003956564819968::Int256 FROM system.one AS f0"
      ...
      assert one(
               ...
               "SELECT 57896044618658097711785492504343953926634992332820282019728792003956564819967 = 57896044618658097711785492504343953926634992332820282019728792003956564819967::Int256 FROM system.one AS f0"
      ...
      assert one(
               ...
               "SELECT 115792089237316195423570985008687907853269984665640564039457584007913129639935 = 115792089237316195423570985008687907853269984665640564039457584007913129639935::UInt256 FROM system.one AS f0"
    end
  end
end
